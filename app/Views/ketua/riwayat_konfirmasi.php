                            ...
                            <?php if (!empty($pembayaranList)): ?>
                                <?php foreach ($pembayaranList as $pembayaran): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Opsi untuk membatalkan konfirmasi atau penolakan jika diperlukan -->
                                            <?php if ($pembayaran['status'] === 'Dikonfirmasi'): ?>
                                                <a href="<?= base_url('bendahara/konfirmasi_pembayaran/tolak/' . $pembayaran['id_pembayaran']) ?>" class="btn btn-warning">Batalkan Konfirmasi</a>
                                            <?php elseif ($pembayaran['status'] === 'Ditolak'): ?>
                                                <a href="<?= base_url('bendahara/konfirmasi_pembayaran/konfirmasi/' . $pembayaran['id_pembayaran']) ?>" class="btn btn-success">Konfirmasi Ulang</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
