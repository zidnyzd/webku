...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('ketua/warga/update/' . $warga['id_user']) ?>" method="post">
                    <?= csrf_field() ?>
                    
                    <!-- Nama Lengkap -->
                    <div class="form-group">
                        <label for="nama_lengkap">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= esc($warga['nama_lengkap']) ?>" required placeholder="Masukkan Nama Lengkap">
                    </div>

                    <!-- NIK -->
                    <div class="form-group">
                        <label for="nik">NIK</label>
                        <input type="text" class="form-control" id="nik" name="nik" minlength="16" maxlength="16" value="<?= esc($warga['nik']) ?>" required placeholder="Masukkan NIK">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="no_kk" name="no_kk" minlength="16" maxlength="16" value="<?= esc($warga['no_kk']) ?>" required placeholder="Masukkan No KK">
                    </div>

                    <!-- Alamat -->
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <textarea class="form-control" id="alamat" name="alamat" required placeholder="Masukkan Alamat"><?= esc($warga['alamat']) ?></textarea>
                    </div>

                    <!-- Blok/No -->
                    <div class="form-group">
                        <label for="blok_no">Blok/No</label>
                        <input type="text" class="form-control" id="blok_no" name="blok_no" value="<?= esc($warga['blok_no']) ?>" placeholder="Masukkan Blok/No">
                    </div>

                    <!-- Dawis -->
                    <div class="form-group">
                        <label for="dawis">Dawis</label>
                        <input type="text" class="form-control" id="dawis" name="dawis" value="<?= esc($warga['dawis']) ?>" placeholder="Masukkan Dawis">
                    </div>

                    <!-- Nomor Telepon -->
                    <div class="form-group">
                        <label for="no_telpon">Nomor Telepon</label>
                        <input type="text" class="form-control" id="no_telpon" name="no_telpon" value="<?= esc($warga['no_telpon']) ?>" placeholder="Masukkan Nomor Telepon">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?= esc($warga['tempat_lahir']) ?>" required placeholder="Masukkan Tempat Lahir">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" value="<?= esc($warga['pekerjaan']) ?>" required placeholder="Masukkan Pekerjaan">
                    </div>
