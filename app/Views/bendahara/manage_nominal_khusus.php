                                ...
                                <tr>
                                    ...
                                    <form id="form-<?= $warga['id_user'] ?>" action="<?= base_url('/bendahara/update_nominal_khusus/' . $warga['id_user']) ?>" method="post">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="nominal-khusus-<?= $warga['id_user'] ?>" class="form-control nominal-input" placeholder="Masukkan Nominal Khusus">
                                        </div>
                                    </form>
                                    ...
                                    <td>
                                        <button type="submit" form="form-<?= $warga['id_user'] ?>" class="btn btn-primary btn-sm">Update</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
