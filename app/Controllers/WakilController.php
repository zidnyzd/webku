...
class WakilController extends BaseController
{
    ...
    public function wargaList()
    {
        ...
        return view('wakil/catat_iuran_warga', ['wargaList' => $wargaList, 'title' => 'Daftar Warga']);
    }

    // Form create warga baru
    public function create()
    {
        return view('wakil/create_warga', ['title' => 'Tambah Warga Baru']);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/wakil/warga')->with('success', 'Data warga berhasil ditambahkan.');
    }
    ...
    public function edit($id_user)
    {
        ...
        return view('wakil/edit_warga', ['warga' => $warga, 'title' => 'Edit Warga']);
    }
    ...
    public function update($id_user)
    {
        ...
        return redirect()->to('/wakil/warga')->with('success', 'Data warga berhasil diperbarui.');
    }
    ...
    public function deleteWarga($id_user)
    {
        if ($this->wargaModel->delete($id_user)) {
            ...
            return redirect()->to('/wakil/warga')->with('success', 'Warga berhasil dihapus.');
        } else {
            return redirect()->to('/wakil/warga')->with('error', 'Gagal menghapus warga.');
        }
    }
    ...
    public function manageNominalKhusus()
    {
        ...
        return view('wakil/manage_nominal_khusus', [
    ...
    public function editNominalKhusus($id_user)
    {
        ...
        // Kirim data ke view
        return view('wakil/edit_nominal_khusus', [
    ...
    public function updateNominalKhusus($id_user, $id_iuran)
    {
        ...
        return redirect()->to('/wakil/manage_nominal_khusus')->with('success', 'Nominal Khusus berhasil diperbarui.');
    }
    ...
    public function catatIuran($id_user)
    {
        $warga = $this->wargaModel->find($id_user);
        if (!$warga) {
            return redirect()->to('/wakil/warga')->with('error', 'Warga tidak ditemukan.');
        }
